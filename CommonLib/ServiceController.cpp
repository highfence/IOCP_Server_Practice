...
namespace CommonLib
{
	SERVICE_STATUS_HANDLE ServiceController::theServiceStatusHandle = (SERVICE_STATUS_HANDLE)0;
	SERVICE_STATUS ServiceController::theServiceStatus;

	const BOOL ServiceController::InstallServer(const LPCTSTR strServiceName, const LPCTSTR strServiceDir)
	{
		SC_HANDLE hSCM = NULL;
	...
	const BOOL ServiceController::UnInstallServer(const LPCTSTR strServiceName)
	{
		SC_HANDLE		hSCM = NULL;
		SC_HANDLE		hService = NULL;
	...
	const DWORD ServiceController::ServiceQueryState(const LPCTSTR strServiceName)
	{
		SC_HANDLE		hSCM = NULL;
		SC_HANDLE		hService = NULL;
		SERVICE_STATUS	ssStatus;
	...
	const BOOL ServiceController::ServiceStart(const LPCTSTR strServiceName)
	{
		SC_HANDLE		hSCM = NULL;
		SC_HANDLE		hService = NULL;
		SERVICE_STATUS	ssStatus;
	...
	const BOOL ServiceController::ServiceStop(const LPCTSTR strServiceName)
	{
		SC_HANDLE		hSCM = NULL;
		SC_HANDLE		hService = NULL;
		SERVICE_STATUS	ssStatus;
	...
	const BOOL ServiceController::RegisterService(const LPCTSTR strServiceName, const LPHANDLER_FUNCTION lpHandlerProc)
	{
		DWORD status = 0;
	...
	const VOID ServiceController::UpdateServiceStatus(const DWORD dwStatus)
	{
